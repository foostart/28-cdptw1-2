<div class="type-1455">
      ...
      <div class="container py-5 my-5">
        <div class="row text-center pb-4">
            <div class="col-md-12">
                <h2 class="text-white siyah-cerceve">Template Form Search</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <select id="ilceler" class="form-control" >
                                        <option selected>Ho Chi Minh City</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <select id="arac-turu" class="form-control" >
                                        <option selected>20 ages</option>
                                        <option>21 ages</option>
                                        <option>22 ages</option>
                                        <option>23 ages</option>
                                        <option>24 ages</option>
                                        <option>25 ages</option>
